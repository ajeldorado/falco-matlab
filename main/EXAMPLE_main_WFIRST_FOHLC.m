...
EXAMPLE_defaults_WFIRST_FOHLC_design
...
mp.jac.zerns = [1,4];  %--Which Zernike modes to include in Jacobian. Given as the max Noll index. Always include the value "1" for the on-axis piston mode.
...
mp.dm8.act_sens = 1e1; %1e-1;%1; %--Change in oomph (E-field sensitivity) of DM8 actuators. Chosen empirically based on how much DM8 actuates during a control step. Larger than 1 is way too strong.
