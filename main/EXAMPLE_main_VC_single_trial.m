...
% Vortex coronagraph example script
...
mp.d_dm1_dm2 = 0.3; % distance between DM1 and DM2 (meters)
...
switch mp.whichPupil
    case 'Simple' % Can be used to create circular and annular apertures with radial spiders 
        ...
        mp.P4.ODnorm = 0.9;% Outer diameter (fraction of Nbeam) 
...
mp.P2.D =     48*400e-6; % beam diameter at pupil closest to the DMs  (meters)
...
mp.flagDMwfe = false;
% mp.dm1.wfe = fitsread('data/DM/bmc_surf_errors/bmc_wfe_1000pix.fits');
% mp.dm2.wfe = fitsread('data/DM/bmc_surf_errors/bmc_wfe_1000pix.fits');
