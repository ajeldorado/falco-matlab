...
mp.F4.corr.Rin  = 4; %--lambda0/D, inner radius of correction region
...
mp.F4.sides = 'right'; %--options: 'left', 'right','top','bottom'; any other values produce an annular region 
