...
mp.SeriesNum = 30; %--Use the same Series # for sets of similar trials.


mp.aoi = 7.95; % Angle of incidence at FPM [deg]
...
mp.dm1.ytilt = 8.986; % degrees
mp.dm2.ytilt = 8.986; % degrees


% mp.flagDM1stop = false; %--logical flag whether to include the stop at DM1 or not
mp.flagDM2stop = false;%true; %--logical flag whether to include the stop at DM2 or not
