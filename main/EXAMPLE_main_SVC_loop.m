...
for index = 1:1 %length(RMSs) %length(res)
    ...
    mp.P1.full.Nbeam = 256; %res(index); %make sure this line is commented out in EXAMPLE_defaults_HCST_SVC_chromatic
    mp.P1.compact.Nbeam = 256; %res(index); %make sure this line is commented out in EXAMPLE_defaults_HCST_SVC_chromatic
