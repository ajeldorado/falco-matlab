...
pupil = padOrCropEven(mp.P1.compact.mask,DM.compact.NdmPad);
...
if(mp.flagDM2stop); DM2stop = padOrCropEven(mp.dm2.compact.mask, DM.compact.NdmPad); else DM2stop = 1; end
