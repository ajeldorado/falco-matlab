...
function Gscalar = model_Jacobian_no_FPM(mp, imode, whichDM, iact)
...
lyotStopReimaged = mp.jac.lyotStopReimaged;
...
if whichDM == 1 
    ...
    Gscalar = dEFendPeak / sqrt(mp.Fend.compact.I00(modvar.sbpIndex));
