...
% -------------------------------------------------------------------------
%
% function Eout = model_compact_Roddier(mp, DM, modvar)
...
% REVISION HISTORY:
% --------------
% Modified on 2018-11-20 from model_compact_LC by G. Ruane
...
function Eout = model_compact_Roddier(mp, lambda, Ein, normFac, flagEval)
