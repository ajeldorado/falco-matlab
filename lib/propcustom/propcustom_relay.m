...
% causes a 180-degree rotation and a multiplication by 1/1j. The centering has to be 
...
function Eout = propcustom_relay(Ein,Nrelay,varargin)
    ...
    Eout = (1/1j)^(2*Nrelay)*rot90(Ein,2*Nrelay);  %--Forward propagate two Fourier transforms by rotating 180 degrees. The (1/1j)^2 is from the coefficients of the two FTs.
