...
function ap = falco_hex_aperture_HWO_EAC1(bmi, nr, hr, hs, varargin)
%        ap = falco_hex_aperture_HWO_EAP1(bmi, nr, hr, hs, varargin)
...
% 2025 Apr 10  ar   Changed to be specific to the HWO EAP1 aperture.
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
