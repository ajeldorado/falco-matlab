...
if mp.aux.flagOmega==1 && cvar.Itr>=mp.aux.firstOmegaItr
    duVec = -dmfac*(diag(reg_diag) + diag(mp.aux.gamma*cvar.EyeGstarGdiag) + cvar.GstarG_wsum - 10^mp.aux.omega * cvar.GcptransGcp_wsum)...
        \(cvar.RealGstarEab_wsum...
        +mp.aux.gamma*10^(log10reg)*cvar.EyeGstarGdiag.*...
        vec_dm_ele);
elseif mp.aux.peakJacKern
    duVec =  -dmfac*(diag(reg_diag) + diag(mp.aux.gamma*cvar.EyeGstarGdiag) + cvar.GstarG_wsum)...
