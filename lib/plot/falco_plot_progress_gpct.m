...
tb_andor_fitswrite(mp.bench,Im,[out_dir,'normI_it',num2str(Itr-1),'.fits']);
tb_andor_fitswrite(mp.bench,mp.dm1.V,[out_dir,'dmV_it',num2str(Itr-1),'.fits']);
tb_andor_fitswrite(mp.bench,DM1surf,[out_dir,'dmmodel_it',num2str(Itr-1),'.fits']);

if(Itr>1)
    tb_andor_fitswrite(mp.bench,abs(Im_tb.E).^2,[out_dir,'normI_Esens_it',num2str(Itr-2),'.fits']);
    tb_andor_fitswrite(mp.bench,angle(Im_tb.E),[out_dir,'phz_Esens_it',num2str(Itr-2),'.fits']);
end
