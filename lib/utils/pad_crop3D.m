...
%
% Modified from pad_crop() to manage 3D cubes. The 1st two axes will be treated
% as in pad_crop while the 3rd axis will remain unchanged.
%
...
function arrayOut = pad_crop3D(arrayIn, nDes, varargin)
    ...
    arrayOut = extrapval * ones(nOutY, nOutX, size(arrayIn,3));
