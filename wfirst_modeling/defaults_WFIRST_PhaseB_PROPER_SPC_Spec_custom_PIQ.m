...
file_dir = '/Users/ajriggs/Repos/proper-models/wfirst_cgi/data_phaseb/spc_spec_custom/spc_20200525/';
% file_dir = '/Users/ajriggs/Documents/Sim/cgi/wfirst_phaseb/spc_spec_custom/';

mp.full.pupil_mask_file = [file_dir, 'SPM_SPC-20200525.fits'];
...
mp.full.pupil_file = [file_dir, 'pupil_SPC-20200525.fits'];
mp.full.pupil_diam_pix = 1000;
mp.full.fpm_file = [file_dir, 'fpm_0.05lamdivD_SPC-20200525.fits'];
mp.full.fpm_sampling_lam0 = 0.05; 	% sampling in lambda0/D of FPM mask
mp.full.lyot_stop_file = [file_dir,'LS_SPC-20200525.fits'];
...
% mp.F3.Rout = 9.4;   % radius of outer opaque edge of FPM [lambda0/D]
% mp.F3.ang = 65;    % on each side, opening angle [degrees]
% 
% %--Lyot stop shape
% mp.compact.flagGenLS = true;
% mp.LSshape = 'bowtie';
% mp.P4.IDnorm = 0.42; %--Lyot stop ID [Dtelescope]
...
mp.whichPupil = 'WFIRST20200513';%'WFIRST180718';
...
FPM0 = fitsread('fpm_0.05lamdivD_SPC-20200525.fits'); %--Resolution of 20 pixels per lambda0/D
FPM0 = padOrCropOdd(FPM0, 401);
