...
function mp = falco_verify_key_values(mp)
    ...
    mp.allowedEstimators = {'perfect', 'pairwise', 'pairwise-square', 'pwp-bp-square', 'pairwise-rect', ...
        'pwp-bp', 'pwp-kf', 'pairwise-kf', 'pairwise-rect-kf', 'scc', 'iefc', 'ekf_maintenance', 'borde-traub', 'bt', 'bt-kf', 'bt-rect', 'bt-rect-kf', 'modal_ekf_maintenance'};
    mp.allowedControllers = {'gridsearchefc', 'plannedefc', 'modal'};
