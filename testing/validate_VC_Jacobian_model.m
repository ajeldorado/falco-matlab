...
% -------------------------------------------------------------------------
%
%--Script to compare the vortex coronagraph Jacobian from model_Jacobian with those made by
...
%% Step 1: Define any variable values that will overwrite the defaults (in falco_config_defaults_VC)
...
mp.coro = 'Vortex';   %--Tested Options: 'Vortex','LC','SPLC'
...
[mp,cp,ep,DM] = falco_config_defaults_VC(mp,cp,ep,DM); %--Load values
