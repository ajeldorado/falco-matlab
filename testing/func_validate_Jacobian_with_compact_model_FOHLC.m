...
function JacCol = func_validate_Jacobian_with_compact_model_FOHLC(iact,whichDM, dV, EunpokedVec, mp,  lambda, normFac, Ein)
    ...
    if(flagSkipAct)
        ...
        Epoked = model_compact_FOHLC(mp, lambda, normFac, Ein, flagEval); 
        %Epoked = model_compact_FOHLC(mp, DM,  lambda, normFac, Ein, FPM);
