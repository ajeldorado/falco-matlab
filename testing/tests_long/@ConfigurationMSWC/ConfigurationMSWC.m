...
mp.fracBW = 0.066;       %--fractional bandwidth of the whole bandpass (Delta lambda / lambda0)
...
mp.est.probe.yOffset = 0;    % offset of probe center in y at DM [actuators]. Use to avoid central obscurations.
mp.est.probe.gainFudge = [1, 1];     % empirical fudge factor to make average probe amplitude match desired value.
