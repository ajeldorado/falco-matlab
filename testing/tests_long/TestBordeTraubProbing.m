...
%---------------------------------------------------------------------------
%% Test Borde-Traub Probing
%
% We test the function falco_est_borde_traub_probing.m.
classdef TestBordeTraubProbing < matlab.unittest.TestCase    
%% Properties
%
%% Properties
%
...
%  Creates four tests:
%
% # *testPairwiseProbing* Test falco_est_borde_traub_probing.m.                                   
    methods (Test)    
        function testPairwiseProbing(testCase)
            ...
            mp.runLabel = 'testing_borde_traub_probing';
