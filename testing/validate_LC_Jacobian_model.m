...
% -------------------------------------------------------------------------
%
%--Script to compare the LC Jacobian from model_Jacobian with those made by
...
switch mp.whichPupil
    ...
    case 'WFIRST_onaxis'
        mp.P1.D = 2.3631; %--meters, diameter of telescope (used only for mas to lambda/D conversion)
        mp.pup_strut_width = 3.2126/100.; %--0.0261  is nominal from 2014 on-axis (in pupil diameters)
        mp.LS_strut_width = 3.8/100.; % nominal pupil's value is 76mm = 3.216%
...
[mp,cp,ep,DM] = falco_config_defaults_LC(mp,cp,ep,DM); %--Load values
