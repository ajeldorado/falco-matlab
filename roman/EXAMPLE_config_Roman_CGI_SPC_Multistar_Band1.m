...
addpath('D:\dansWork\MSWC\hcitOMC\cgisim\roman_phasec_v1.2.9a\matlab\'); savepath; 
...
SP0 = fitsread([mp.full.data_dir filesep 'spc_20200623_mswc' filesep 'SPM_SPC-20200623_982_rounded9_gray.fits']);
SP0 = pad_crop(SP0, 983);
SP0 = rot90(SP0, 2);
