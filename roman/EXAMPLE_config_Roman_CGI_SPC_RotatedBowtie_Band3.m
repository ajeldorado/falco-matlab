...
mp.full.cor_type = 'spc-spec_rotated_band3';
...
mp.full.dm1.flatmap = fitsread('dm1_m_spc-spec_rotated_band3.fits');
mp.full.dm2.flatmap = fitsread('dm2_m_spc-spec_rotated_band3.fits');
