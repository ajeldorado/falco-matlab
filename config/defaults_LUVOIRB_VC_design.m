...
mp.F4.FOV = 20; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.F4.corr.Rin = 2.0;   % inner radius of dark hole correction region [lambda0/D]
mp.F4.corr.Rout  = 15;  % outer radius of dark hole correction region [lambda0/D]
mp.F4.corr.ang  = 180;  % angular opening of dark hole correction region [degrees]

mp.F4.score.Rin = 2.0;  % inner radius of dark hole scoring region [lambda0/D]
mp.F4.score.Rout = 15;  % outer radius of dark hole scoring region [lambda0/D]
