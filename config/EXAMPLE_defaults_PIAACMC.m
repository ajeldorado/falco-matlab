...
mp.dm1.dm_spacing = 0.28125e-3; %--User defined actuator pitch
mp.dm2.dm_spacing = 0.28125e-3;
...
mp.dm1.VtoH = 1*1e-9*ones(32);  % gains of all actuators [nm/V of free stroke]
...
mp.dm2.VtoH = 1*1e-9*ones(32);  % gains of all actuators [nm/V of free stroke]
...
mp.d_dm1_dm2 = 0.0;   % distance between DM1 and DM2 [meters]
...
mp.P1.IDnorm = 0.0;
mp.P4.downSampFac = 4; %LS file I have is 2048 pix while pupil map is 512.  FIX HARDCODEDNESS BEFORE RELEASE!
mp.F3.downSampFac = 8; %FPM file is 2056x2056, which is gi-friggin'-gantic.

%--Pupil Plane Resolutions
mp.P1.compact.Nbeam = 512;
mp.P2.compact.Nbeam = 512;
mp.P3.compact.Nbeam = 512;
mp.P4.compact.Nbeam = 512;
