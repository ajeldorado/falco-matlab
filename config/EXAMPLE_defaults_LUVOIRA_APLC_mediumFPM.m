...
mp.Fend.FOV = 25.; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.Fend.corr.Rin = 6.82;   % inner radius of dark hole correction region [lambda0/D]
mp.Fend.corr.Rout  = 23;  % outer radius of dark hole correction region [lambda0/D]
mp.Fend.corr.ang  = 180;  % angular opening of dark hole correction region [degrees]

mp.Fend.score.Rin = 6.82;  % inner radius of dark hole scoring region [lambda0/D]
mp.Fend.score.Rout = 23;  % outer radius of dark hole scoring region [lambda0/D]
...
mp.P3.compact.mask = double(imread('0_LUVOIR_N1000_FPM682M0250_IWA0672_OWA02372_C10_BW10_Nlam5_LS_IDD0120_OD0982_no_ls_struts.png'))/255;
...
mp.F3.Rin = 6.82;    % maximum radius of inner part of the focal plane mask [lambda0/D]
