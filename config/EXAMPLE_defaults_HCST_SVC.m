...
mp.flagJitter = false; %THIS IS THE LINE I HAD TO ADD (NIYATI)
...
maskaux = fitsread('/Users/niyatid/falco-matlab/lib/masks/segmentedPupil_noApod.fits');%   ApodizedPupil_HCST
