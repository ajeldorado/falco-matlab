...
mp.dm1.dm_spacing = 400e-6;%0.9906e-3;%1e-3; %--User defined actuator pitch
mp.dm2.dm_spacing = 400e-6;%0.9906e-3;%1e-3; %--User defined actuator pitch
...
mp.dm1.Dstop = 50*mp.dm1.dm_spacing;  %--Diameter of iris [meters]
mp.flagDM2stop = true;  %--Whether to apply an iris or not
mp.dm2.Dstop = 50*mp.dm2.dm_spacing;   %--Diameter of iris [meters]
...
mp.P2.D = 46.2987*400e-6;
mp.P3.D = 46.2987*400e-6;
mp.P4.D = 46.2987*400e-6;
...
mp.t_diel_nm_vec = 0:mp.dt_diel_nm:0;%900; %--PMGI thickness range and sampling (nm)
...
mp.dm9.V0coef = 0;%390; % Nominal PMGI layer thickness [nm] 
...
mp.dm9.actres = 3;%4;%7; % number of "actuators" per lambda0/D in the FPM's focal plane. On a square actuator array.
