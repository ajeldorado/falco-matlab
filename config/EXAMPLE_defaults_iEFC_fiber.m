...
mp.Fend.corr.Rin = 5.99;   % inner radius of dark hole correction region [lambda0/D]
mp.Fend.corr.Rout  = 10;  % outer radius of dark hole correction region [lambda0/D]
mp.Fend.corr.ang  = 1;  % angular opening of dark hole correction region [degrees]

mp.Fend.score.Rin = 6.01;  % inner radius of dark hole scoring region [lambda0/D]
mp.Fend.score.Rout = 10;  % outer radius of dark hole scoring region [lambda0/D]
mp.Fend.score.ang = 1;  % angular opening of dark hole scoring region [degrees]
