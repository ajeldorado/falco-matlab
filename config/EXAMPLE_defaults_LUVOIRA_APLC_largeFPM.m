...
mp.thput_eval_x = 20; % x location [lambda_c/D] in dark hole at which to evaluate throughput
...
mp.source_x_offset_norm = 20;  % x location [lambda_c/D] in dark hole at which to compute intensity normalization
...
mp.Fend.FOV = 50.; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.Fend.corr.Rin = 13.4;   % inner radius of dark hole correction region [lambda0/D]
mp.Fend.corr.Rout  = 40;  % outer radius of dark hole correction region [lambda0/D]
mp.Fend.corr.ang  = 180;  % angular opening of dark hole correction region [degrees]

mp.Fend.score.Rin = 13.4;  % inner radius of dark hole scoring region [lambda0/D]
mp.Fend.score.Rout = 40;  % outer radius of dark hole scoring region [lambda0/D]
...
mp.P3.compact.mask = double(imread('0_LUVOIR_N1000_FPM1338M0400_IWA1328_OWA04688_C10_BW10_Nlam5_LS_IDD0120_OD0982_no_ls_struts.png'))/255;
...
mp.F3.Rin = 13.38;    % maximum radius of inner part of the focal plane mask [lambda0/D]
