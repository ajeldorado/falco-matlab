...
%--FPM size
mp.F3.Rin = 2.65;    % maximum radius of inner part of the focal plane mask [lambda0/D]
mp.F3.RinA = 2.65;   % inner hard-edge radius of the focal plane mask [lambda0/D]. Needs to be <= mp.F3.Rin 
